function Start-RouletteSpin() {
    ...
    param (
        ...
        [Parameter()]
        [switch]$SuppressOutputText = $false
    )
    ...
    $InsideBets  = @( "split", "street", "corner", "sqaure", "sixline", "doublestreet", "trio", "firstfour", "basket" ) + @( $AllNumbers.Keys )
